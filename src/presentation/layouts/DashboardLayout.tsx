  ...
  return (
    <main className="flex flex-row mt-7">
      <nav className="hidden sm:flex flex-col ml-5 w-[370px] min-h-[calc(100vh-3.0rem)] bg-white bg-opacity-10 p-5 rounded-3xl">
        <h1 className="font-bold text-lg lg:text-3xl bg-gradient-to-br from-white via-white/100 bg-clip-text text-transparent">
          ReactGPT
        </h1>
        <span className="text-xl font-mono font-semibold">Bienvenido</span>
